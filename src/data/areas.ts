...
export const areas: Area[] = [
  ...
  },
  {
    ...
    whyChooseParagraphs: [
      ...
      "Because the village is so close to Amersham Hospital and the wider medical community around Chalfont & Latimer, several of our Little Chalfont clients first heard about us through a recommendation rather than a search engine. That says something about how word travels in a village this size, and why we take discretion as seriously as we do.",
    ],
    consultationParagraph:
  ...
  },
  {
    ...
    distanceLabel: "Around 9 miles / 20 to 25 minutes via Chesham or the A41",
    introParagraphs: [
