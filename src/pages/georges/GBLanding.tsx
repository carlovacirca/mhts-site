...
const services = [
  ...
  },
  {
    icon: Scissors,
    name: "Kids Haircut",
    desc: "Friendly, patient service for younger gents (under 12).",
    price: "£12",
  },
  {
    icon: Scissors,
    name: "OAP Haircut",
    desc: "Quality cuts for our senior community members.",
    price: "£12",
  },
  {
    icon: Flame,
  ...
  },
  {
    ...
    desc: "Expert beard grooming and sculpting.",
    price: "£8",
  },
  {
    icon: Scissors,
  ...
  },
  {
    icon: CircleDot,
    name: "Body Piercing",
    desc: "Professional body piercing in a clean, sterile environment.",
    price: "From £25",
  },
];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 max-w-4xl mx-auto mb-16">
          <div className="aspect-square rounded-lg overflow-hidden border border-gb-gold/20">
            <img src={gbGallery1} alt="Gents haircut at Georges Barbers" className="w-full h-full object-cover" style={{ objectPosition: 'center 80%' }} />
          </div>
