...
import { CheckCircle2, ChevronRight, CalendarCheck, ArrowLeft } from "lucide-react";
import { findSubService } from "@/data/services";

const placeholderBullets = [
  "Add a key benefit of this specific service",
  "Describe the technique, materials or approach",
  "Highlight what clients can expect from results",
  "Mention duration, longevity or follow-up care",
];

const placeholderSteps = [
  { title: "Consultation", desc: "Placeholder description for the consultation step. Replace with your own copy." },
  { title: "Preparation", desc: "Placeholder description for the preparation step." },
  { title: "Treatment", desc: "Placeholder description for the treatment itself." },
  { title: "Aftercare", desc: "Placeholder description for follow-up and aftercare." },
];

const SubServicePage = () => {
  const { category: categorySlug, sub: subSlug } = useParams();
  const data = categorySlug && subSlug ? findSubService(categorySlug, subSlug) : null;
  ...
  return (
    <div className="mhts-theme">
      {/* HERO */}
      <section className="relative min-h-[50vh] flex items-center bg-mhts-charcoal overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 py-20">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl font-light tracking-wide text-mhts-white mb-6 leading-tight">
              {sub.name}
            </h1>
            <p className="text-mhts-white/70 text-lg max-w-xl mb-10 font-body">{sub.blurb}</p>
            <Link
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 max-w-3xl">
          <div className="text-center mb-10">
            <p className="text-mhts-slate uppercase tracking-[0.2em] text-xs mb-3 font-body">About This Service</p>
          ...
          <p className="text-muted-foreground font-body leading-relaxed text-center mb-8">
            Placeholder description for {sub.name}. Replace this paragraph with detailed information
            about the service, what clients can expect, the techniques used, and the results delivered.
          </p>
      ...
      <section className="py-20 bg-mhts-light">
        <div className="container mx-auto px-4">
          <div className="text-center mb-14">
            <p className="text-mhts-slate uppercase tracking-[0.2em] text-xs mb-3 font-body">The Process</p>
      ...
      {category.subServices.length > 1 && (
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="text-center mb-10">
              <p className="text-mhts-slate uppercase tracking-[0.2em] text-xs mb-3 font-body">Related</p>
              ...
              {category.subServices
                ...
                .map((s) => (
                  <Link
                    ...
                    className="group block bg-mhts-light rounded-sm p-6 border border-border hover:border-mhts-slate/40 transition-colors"
                  >
                    <h3 className="text-base font-medium text-mhts-charcoal mb-2 tracking-wide">{s.name}</h3>
                    <p className="text-muted-foreground text-sm font-body leading-relaxed mb-4">{s.blurb}</p>
